  ...
  do
    ...
    do
      ...
      gnuplot -e "
        ...
        set title 'Changes in the number of acions with {/Symbol a}=${a} {/Symbol g}=${g} {/Symbol e}=${e}';
        set xrange [0:100];
        set yrange [0:*];
        ...
        reset;
        set title 'Changes in total reward with {/Symbol a}=${a} {/Symbol g}=${g} {/Symbol e}=${e}';
        set xrange [0:100];
        unset yrange;
        set xlabel 'Number of trials';
        ...
        reset;
        set title 'Changes in Q with {/Symbol a}=${a} {/Symbol g}=${g} {/Symbol e}=${e}';
        set xrange [0:100];
        unset yrange;
        set xlabel 'Number of trials';
...
gnuplot -e "
  ...
  set ylabel 'Number of actions';
  set key font 'Arial,8.5';
  plot for [a in '${A}'] for [g in '${G}'] for [e in '${E}'] 'E/e_100_'.a.'_'.g.'_'.e.'.dat' title '{/Symbol a}='.a.' {/Symbol g}='.g.' {/Symbol e}='.e with line;
  pause -1;
  set terminal pngcairo enhanced;
